...
router.post('/insertdealersdataintodeliverytable',(req,res)=>{
    ...
    if (reqdata.changed_data != undefined){
        po_number = reqdata.changed_data.po_number;
        pan_number = reqdata.changed_data.pan_number;
        vehicle_number = reqdata.changed_data.vehicle_number;
        place_of_supply = reqdata.changed_data.place_of_supply;
